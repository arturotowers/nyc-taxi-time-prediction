...
# # MLflow settings
# dagshub_repo = "https://dagshub.com/arturotowers/nyc-taxi-time-prediction"
#
# dagshub.init(url=dagshub_repo, mlflow=True)

MLFLOW_TRACKING_URI = "https://dagshub.com/arturotowers/nyc-taxi-time-prediction.mlflow"
