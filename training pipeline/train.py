...
def register_best_model() -> None:
    """Register the best model to the model registry with alias 'champion'"""

    # Initialize the Mlflow Client
    client = MlflowClient()

    # Search for the best run by rmse (ascending order)
    ...
    # Log and register the model from the best run
    ...
    # Assign the 'champion' alias to the new model version
